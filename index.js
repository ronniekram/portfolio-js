            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body" style="background: #262626de;border-radius: 10px;">
                        ...
                        <div class="text-center" style="margin-bottom: 1rem;"><img src="assets/img/portfolio-pic.jpg" style="border: 1px solid rgb(255,255,255);border-radius: 10px;" width="60%" alt="Photo of Arynn"></div>
...
function renderContact() {
    ...
    <div class="social-icons" style="margin-top: 10rem; background: rgba(210,210,210, 0.8); text-align: center; border-radius: 10px;">
        <a href="http://linkedin.com/in/arynn-boniface" target="_blank class="contact-link">
            <img src="assets/img/linkedin.png" class="contact-link" alt="LinkedIn Logo" />
        </a>

        <a href="http://github.com/ronniekram" target="_blank">
            <img src="assets/img/github.png" class="contact-link" alt="Github Logo" />
        </a>

        <a href="https://dev.to/arynnboniface" target="_blank">
            <img src="assets/img/blogging.png" class="contact-link" alt="Blogging Icon" />
        </a>

        <a
        href="mailto:arynn.boniface@gmail.com">
            <img src="assets/img/gmail.png" class="contact-link" alt="Gmail Logo" />
        </a>
</div>`
...
function renderPortfolio() {
    ...
    <div class="d-lg-flex" style="margin-top: 4rem;">
        <div class="container">
            <div class="row">
                <div class="col-md-4"><img src="assets/img/Screen%20Shot%202020-11-22%20at%207.57.14%20PM.png" width="100%" style="border-top-left-radius: 10px;border-top-right-radius: 10px;alt="Screen shot of Sinatra Eleplant App">
                    <div class="card" style="border-width: 0px;">
                        <div class="card-body" style="background: rgba(57,57,57,0.8);border-radius: 0;border-bottom-right-radius: 10px;border-bottom-left-radius: 10px;color: rgb(224,224,224);border-width: 0;border-style: none;">
                            ...
                            <div style="color: rgb(210,210,210);"><a href="https://github.com/ronniekram/sinatra-plant-tracker" style="padding: 0;padding-right: .5rem;color: rgb(210,210,210);font-family: Montserrat, sans-serif;" target="_blank" alt="Link to Eleplant Github Repo">GITHUB</a><a href="https://eleplant-tracker.herokuapp.com/"
                                    style="padding: 0;padding-left: .5rem;color: rgb(210,210,210);font-family: Montserrat, sans-serif;" target="_blank" alt="Link to Eleplant Live Page">SEE IT IN ACTION</a></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4"><img src="assets/img/Screen%20Shot%202020-11-22%20at%207.58.54%20PM.png" width="100%" style="border-top-left-radius: 10px;border-top-right-radius: 10px;" alt="Screen shot of Teacher's Helper Ruby on Rails app" >
                    <div class="card" style="border-width: 0px;">
                        <div class="card-body" style="border-radius: 10px;background: rgba(57,57,57,0.8);font-family: Roboto, sans-serif;border-bottom-left-radius: 10px;border-bottom-right-radius: 10px;border-top-right-radius: 0;border-top-left-radius: 0;color: rgb(224,224,224);">
                            ...
                            <div><a href="https://github.com/ronniekram/teacher-rails-v2" style="padding: 0;padding-right: .5rem;color: rgb(210,210,210);font-family: Montserrat, sans-serif;" target="_blank" alt="Link to Teacher's Helper Github Repo">GITHUB</a><a href="https://teachers-library.herokuapp.com/"
                                    style="padding: 0;padding-left: .5rem;color: rgb(210,210,210);font-family: Montserrat, sans-serif;" target="_blank" alt="Link to Teacher's Helper Live Page">SEE IT IN ACTION</a></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4"><img src="assets/img/seeking-guidance.png" width="100%" style="border-top-left-radius: 10px;border-top-right-radius: 10px;border-bottom-right-radius: 0;border-bottom-left-radius: 0;" alt="Screen shot of Seeking Guidance, Rails/JavaScript app" >
                    <div class="card" style="border-width: 0px;">
                        <div class="card-body" style="border-radius: 10px;background: rgba(57,57,57,0.8);font-family: Roboto, sans-serif;border-top-left-radius: 0;border-top-right-radius: 0;border-bottom-right-radius: 10px;border-bottom-left-radius: 10px;color: rgb(224,224,224);">
                            ...
                            <div><a href="https://github.com/ronniekram/tarot-js" style="padding-right: .5rem;color: rgb(210,210,210);font-family: Montserrat, sans-serif;" target="_blank" alt="Link to Seeking Guidance Repo">GITHUB</a><a href="https://ronniekram.github.io/tarot-frontend/" style="padding-left: .5rem;color: rgb(210,210,210);font-family: Montserrat, sans-serif;"
                                    target="_blank" alt="Link to Seeking Guidance Live Page">SEE IT IN ACTION</a></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div style="margin-top: 5rem;">
        <div class="container">
            <div class="row">
                <div class="col-md-4"><img src="assets/img/village-watch.png" width="100%" style="border-top-left-radius: 10px;border-top-right-radius: 10px;" alt="Screenshot of Village Watch, React/Redux and Rails app">
                    <div class="card" style="border-width: 0px;">
                        <div class="card-body" style="border-radius: 10px;background: rgba(57,57,57,0.8);font-family: Roboto, sans-serif;border-top-left-radius: 0;border-top-right-radius: 0;border-bottom-right-radius: 10px;border-bottom-left-radius: 10px;border-style: none;color: rgb(224,224,224);">
                            ...
                            <div><a href="https://github.com/ronniekram/ac-villager-front" style="padding-right: .5rem;color: rgb(210,210,210);font-family: Montserrat, sans-serif;" target="_blank" alt="Link to Villager Watch Github Repo">GITHUB</a><a href="https://village-watch.netlify.app/" style="padding-left: .5rem;color: rgb(210,210,210);font-family: Montserrat, sans-serif;"
                                    target="_blank" alt="Link to Village Watch Live Page">SEE IT IN ACTION</a></div>
                        </div>
                    </div>
                </div>
